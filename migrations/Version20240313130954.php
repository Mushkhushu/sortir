 ...
 */
final class Version20240313130954 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lieu DROP site');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lieu ADD site VARCHAR(255) NOT NULL');
    }
}
